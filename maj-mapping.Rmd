...
```{r etabs.load}
etabs <- bind_rows(
  kpiesr_read.etab() %>% mutate(dataset = "etab.23"),
  kpiesr_read.etab("dataESR/fr-esr-principaux-etablissements-enseignement-superieur.2022.csv") %>% mutate(dataset = "etab.22"),
  kpiesr_read.etab("dataESR/fr-esr-principaux-etablissements-enseignement-superieur.2021.csv") %>% mutate(dataset = "etab.21.2"),
