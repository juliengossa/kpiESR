...
- `r fin %>% select(uai...identifiant, groupe) %>% filter(groupe == "") %>% unique() %>% nrow()` groupes manquant
- `r fin %>% select(uai...identifiant, etablissement) %>% filter(etablissement == "") %>% unique() %>% nrow()` nom d'établissement manquant
