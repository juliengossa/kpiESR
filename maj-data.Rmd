...
1. Définition du groupage des établissements
    1. Utilisation d'un groupement manuel basé sur `etab.21`
    1. Groupage automatique des établissements hors `etab.21`
      1. Groupage dans `Universités et assimilés` des établissements dont le nom contient "Université"
      1. Groupage dans `Autres` pour les autres.
    1. Vérification des groupages automatiques
1. Fusion des jeux de données

### Attention

La cohérence du périmètres global `Ensemble` dépend de la cohérence du périmètre
des jeux de données.

La cohérence des périmètres sur les groupes dépend aussi des établissements identifiés dans 
`etab.21`, sauf pour les université où elle dépend également du groupage automatique.
...
correspondances.doubleuai <- bind_rows(
  c(Etablissement="INSA CVL	",
    from="0180974L;0411068N",to="0180974L", note="Double UAI"),
  c(Etablissement="INSA CVL	",
    from="0411068N",to="0180974L", note="Double UAI"),
  c(Etablissement="Centrale Lille Institut",
    from="0597139P;0590349J",to="0597139P", note="Double UAI"),
  c(Etablissement="Centrale Lille Institut",
    from="0590349J",to="0597139P", note="Double UAI"),
  c(Etablissement="SIGMA Clermont",
    from="0632086A;0632033T",to="0632033T", note="Double UAI"),
  c(Etablissement="SIGMA Clermont",
    from="0632086A",to="0632033T", note="Double UAI"),
  c(Etablissement="UPEM",
    from="0772502B;0932056E",to="0772502B", note="Double UAI"),
  c(Etablissement="ENS Paris Saclay",
    from="0912423P;0940607Z",to="0940607Z", note="Double UAI"),
  c(Etablissement="ENS Paris Saclay",
    from="0912423P",to="0940607Z", note="Double UAI"),
)
